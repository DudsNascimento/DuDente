...
public class CirurgiaJDBC extends SQLConnection{
    ...
    ArrayList <CirurgiaTable> ListarCirurgias() throws SQLException{
    ...
    boolean AdicionarCirurgia(CirurgiaTable cirurgiaTable) throws SQLException{
    ...
    boolean RemoverCirurgia(CirurgiaTable cirurgiaTable) throws SQLException{
        
        return this.ExecutarUpdate("DELETE FROM cirurgia WHERE id_cirurgia = \""+cirurgiaTable.GetIdCirurgia()+"\";");
    }
    
    boolean AtualizarCirurgia(CirurgiaTable cirurgiaTable) throws SQLException{
